AVE.Modules['VersionNotifier'] = {
    ...
    ChangeLog: [
        ...
        "   NeverEndingVoat",
        "       Parses fetched pages and updates the current mail status and CCP/SCP (ContributionDeltas is not updated with the new info)",
        ...
        "       Since user-comments pages can now be read with NeverEndingVoat the process can no longer repeated twice for the same ID",
        "   UpdateAfterLoadingMore:",
        "       Will now only start and update when the current page is a thread",
        "   Shortkey:",
        "       Pressing the expand key in a thread with the OP's submission selected will toggle all media within the selftext",
        "       Ctrl+Return can be used to submit ",
        "V2.33.14.26",
