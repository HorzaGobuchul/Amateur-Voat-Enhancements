...
AVE.Modules['VersionNotifier'] = {
    ...
    ChangeLog: [
        ...
        "       Collapsed comment-chains were position too far right",
        "       Reply forms next to the sidebar would leave a blank place below",
        ...
        "   ShortKeys:",
        "       Use enter (default value) to collapse/expand child-comment and also to load new replies",
