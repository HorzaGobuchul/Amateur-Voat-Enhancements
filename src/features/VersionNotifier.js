AVE.Modules['VersionNotifier'] = {
    ...
    ChangeLog: [
        "V2.29.4.6",
        "   Dashboard:",
        "       In the Usertags section, added context value",
        "   PreferenceManager:",
        "       You can no longer open several changelogs by clicking the version number multiple times",
        "   UserTag:",
        "       Only used data will be saved for optimization's sake. I.e. upvoting someone will no longer save a new complete UserTagObj but a simple obj containing a username and a votebalance",
        ...
        "       An empty votebalance span is not displayed anymore so that it doesn't show an empty space after the tag/username",
        "   BuilDep.js files",
        ...
        "       Attempt at fixing a highlighting error related to Voat displaying comment's dates in CET (GMT+1)",
